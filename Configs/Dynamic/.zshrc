...
# 脚本路径配置
export SCRIPT_HOME="$HOME/Environments/Scripts"
export PATH=$SCRIPT_HOME/Environments_init:$PATH
export PATH=$SCRIPT_HOME/Daily_auto:$PATH

# kitty配置
# export KITTY_HOME=/usr/bin/kitty
# export PATH=$KITTY_HOME/bin:$PATH
alias  vimk='vim ~/.config/kitty/kitty.conf'
# function sk() {
# 	/home/luky/.config/kitty/switch.sh  1> /dev/null 2>&1
# 	echo "kitty theme update"
# }
...
alias vim='nvim'
# zathura路径
alias  vimt='vim ~/.config/zathura/zathurarc'
...
# google配置
# alias google='nohup google-chrome > /home/luky/Log/nohup.out &'

# yazi路径
# export YAZI_HOME=/usr/local
# export PATH=$YAZI_HOME/yazi:$PATH
export EDITOR='nvim'
...
function vimj() {
    ...
    case "$1" in
        ...
        "z") vim ~/.zshrc ;;
        "t") vim ~/.tmux.conf ;;
        *) echo "Invalid option: $1. Use 'k', 'c','t', or 'l'." >&2 ;;
    esac
}
# end
#################################################
